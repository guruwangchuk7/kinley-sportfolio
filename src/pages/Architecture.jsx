    ...
    <div className="min-h-screen w-full bg-[#FAF9F6] pt-6 md:pt-8 pb-40 px-6 md:px-8 font-sans selection:bg-black selection:text-white relative">
      ...
      <div className="flex flex-col gap-24 mt-0">
        {categories.map((category) => (
          <div key={category} className="flex flex-col gap-12 md:gap-16">
            {/* Category Title */}
            <div className="flex justify-end">
              <span className="text-[10px] md:text-xs uppercase tracking-[0.4em] text-[#1A1A1A]/20 border-b border-[#1A1A1A]/10 pb-1">{category}</span>
            </div>
